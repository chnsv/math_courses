...
const ReviewsPage: React.FC = () => {
    ...
    const reviews = [
        { id: 1, name: 'Анна Иванова', grade: '11 класс', text: 'Отличный курс! За 2 месяца подтянула математику с 60 до 85 баллов. Особенно понравилась проверка уравнений — сразу видно ошибки, можно учиться на них. Платформа очень удобная, всё интуитивно понятно. Спасибо создателям!', rating: 5, date: '15.03.2026', avatar: '👩‍🎓' },
